...
namespace SoundDevelop
{
    public class SoundFile
    {
        ...
        public static void WriteToWaveFile(SoundSignal ss)
        {
            // Local
            WavFileHeader header = new WavFileHeader();

            // Local
            string filePath = @"C:\Prime\Sound\" + ss.Name + @".wav";
        ...
        public static void WriteToTextFile(SoundSignal ss,int nsamples)
        {
            // Local
            string filePath = @"C:\Prime\Sound\" + ss.Name + @".csv";
