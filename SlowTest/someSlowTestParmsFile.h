...
class SlowTestParmsFile : public Ris::BaseCmdLineParms
{
public:
   ...
   Dsp::SlowThresholderParmsWrapper  mTestThresholderParmsWrapper;
...
#ifdef _SOMESLOWTESTPARMSFILE_CPP_
   SlowTestParmsFile gSlowTestParmsFile;
#else
   extern SlowTestParmsFile gSlowTestParmsFile;
#endif
